...
export default function MarqueeBar() {
  ...
  return (
    <div className="bg-background overflow-hidden py-3 border-b border-border/60">
      <div className="animate-marquee flex whitespace-nowrap items-center">
        {[...items, ...items].map((item, i) => (
          <span
            key={i}
            className="inline-flex items-center gap-3 mx-5 text-[12px] text-foreground/80 capitalize"
          >
            <BoxIcon />
            {item}
          </span>
